...
<div class="navbar bg-base-100 container mx-auto">
  <div class="flex-1">
    <a class="btn btn-ghost normal-case text-xl" href="/">Internet Chowkidar</a>
  </div>
  <div class="flex-none">
    <ul class="menu menu-horizontal px-1 hidden sm:flex font-bold text-lg">
      <li class="md:mx-2"><a href="/">Home</a></li>
      <li class="md:mx-2"><a href="/sites">Sites</a></li>
...
<!--    </nav>-->
    <aside>
      <span class="footer-title opacity-80">Made during FOSSHACK24</span>
<!--      <a-->
